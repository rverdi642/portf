...
class App extends Component {
  render() {
    ...
    <Layout >
        <Header transparent className="header-color"  title={<Link style={{textDecoration: 'none', color: 'white'}} to="/">Home</Link>} scroll >
        ...
        {/* <Drawer style={{backgroundColor: 'rgba(0, 0, 0, 0.579)'}} title={<Link style={{textDecoration: 'none', color: 'black'}} to="/">Richard Verdier</Link>}>
